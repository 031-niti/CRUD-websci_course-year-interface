  ...
  ?>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                <form name="frmadd" method="post" action="../controller/con_edit_course.php"
                    ...
                    <div class="form-group row" style="margin-top: 20px;">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="cs_img" class="form-control" id="cs_img"
                                value="<?php echo $rs2['cs_img']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group row" style="margin-top: 20px;">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="cs_schedule" class="form-control" id="cs_schedule"
                                value="<?php echo $rs2['cs_schedule']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group row" style="margin-top: 20px;">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="cs_range_date" class="form-control" id="cs_range_date"
                                value="<?php echo $rs2['cs_range_date']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group row" style="margin-top: 20px;">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="cs_location" class="form-control" id="cs_location"
                                value="<?php echo $rs2['cs_location']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group row" style="margin-top: 20px;">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="cs_wallet" class="form-control" id="cs_wallet"
                                value="<?php echo $rs2['cs_wallet']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group row" style="margin-top: 20px;">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="cs_phone" class="form-control" id="cs_phone"
                                value="<?php echo $rs2['cs_phone']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group row" style="margin-top: 20px;">
                        ...
                        <div class="col-sm-10" style="margin-bottom: 20px;">
                            <button type="submit" class="btn btn-secondary btn-block"><i class="fa fa-pencil-square"
                                    aria-hidden="true"></i>แก้ไขข้อมูล</button>
                        </div>
