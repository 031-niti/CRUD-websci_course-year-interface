...
<body>
    ...
    <div class="container mt-5" style="width: 1200px;">
        <form method="post" action="../controller/con_add_regis_course.php?cs_id=<?= $rs2['cs_id'] ?>">
            ...
            <p>หากต้องการลงทะเบียนเป็นกลุ่ม ติดต่อไปที่ <a
                    href="mailto:ScishortcoursesNPRU@gmail.com">ScishortcoursesNPRU@gmail.com</a></p>
            ...
            <br>
            <h5>1. ลงทะเบียนหลักสูตรฝึกอบรมระยะสั้น<?php echo $rs2['cs_name'] ?> ค่าลงทะเบียน
                <?php echo $rs2['cs_wallet'] ?></h5>
            ...
            <h5 class="mt-4">2. การชำระเงินโอนผ่านธนาคาร ธนาคารกรุงไทย ประเภทกระแสรายวัน ชื่อบัญชี
                มหาวิทยาลัยราชภัฏนครปฐม เลขที่บัญชี 986 5 34173 5</h5>
            <h5 class="mt-4">3. ยืนยันการชำระเงินแบบฟอร์มยืนยันการชำระเงิน <a
                    href="https://forms.gle/1i1xJFEtwHXbESUU7">https://forms.gle/1i1xJFEtwHXbESUU7</a></h5>
            <button type="submit" class="btn btn-danger mb-5 mt-4" style="margin-right:20px"><a href="./view_course.php"
                    style="color: white;text-decoration:none;">ยกเลิก</a></button>
